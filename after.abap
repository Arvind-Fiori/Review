...
*&---------------------------------------------------------------------*
*&---------------------------------------------------------------------*
*------------------------------------- ASL Modification Log---------------------------------------------------*
*||  Technical Name           ||  Functional Name                || Change Date || TR  Number || Reason for Change
*||  Sahil Patel ( VC-ERP )   ||  Vatsal Shah / Girish Erwar     || 06-08-2025  || ATDK9A0OP0 || Remove ASL Acount group
FORM SEND_MAIL_VEND .
  ...
  IF P_VCRE_S = 'X'.
    ...
    SELECT LIFNR ,
           ...
           WHERE ERDAT IN @S_DATE
            AND ktokk NOT IN ( 'Z013','Z014','Z015','Z017','Z020','Z021','Z022','Z023','Z024','Z025','Z026','Z027'  )."Added by Sahil Patel on 06.08.2025 TR-ATDK9A0OP0
    IF SY-SUBRC EQ 0.
